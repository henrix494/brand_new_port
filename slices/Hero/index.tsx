...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    <Bounded
      ...
      ref={component}
    >
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-3 items-center gap-8">
        <div className="col-span-1 md:col-span-1 flex flex-col justify-center items-start">
          <h1
